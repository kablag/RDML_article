...
\section{Motivation:} Reproducible research is an essential element in science. 
Part of this is are open document standards for data exchange, which preserve 
the set-up and output of experiments in well-defined scheme. The Real-time PCR 
...
selected functions such as . We show that \textit{RDML} enables a seamless analysis with 
...
\cite{roediger2015chippcr}. This GUI allows to edit RDML meta data and view fluorescence curve (\ref{fig:01}). The RDML file format, coordinated by the RDML 
