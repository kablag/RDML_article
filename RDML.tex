...
finding described in \cite{roediger_RJ_2013, roediger2015chippcr, 
spiess_impact_2014, spiess_system-specific_2016}. The intention is to give the 
user an verview of the data for quality control and and experiment planning. It 
is recommended to the users of the \textit{RDML} package to evaluate their own 
analysis pipeline based on evidance based principles as described elsewhere 
...
can be subjeted to further statistical analysis with dedicated algorithems to 
