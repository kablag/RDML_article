...
interface \textbf{rdmlEdit} based on the \textit{shiny} technology as described in 
\cite{roediger2015chippcr}. This GUI allows to edit RDML meta data and view fluorescence curve. The RDML file format, coordinated by the RDML 
