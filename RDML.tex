...
\begin{document} \firstpage{1}
	...
	The RDML file format, coordinated by the RDML consortium 
	(www.rdml.org/), is under continuous development. The \textit{RDML} package 
	follows the changes and supports the current version RDML~v.~1.2. The future 
	improvements of the RDML format will be also incorporated into the package.
	...
	This package can be used as a part of the qPCR processing workflows or 
